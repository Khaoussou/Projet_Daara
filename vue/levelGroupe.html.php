...
<body>
    ...
    <div class="ajoutNiveau">
        <form action="<?= LINK ?>insertlevelGroup" method="post" class="dfex jcc aic form">
        ...
        <table class="table">
            ...
            <?php foreach ($level as $res) { ?>
                ...
                <tr>
                    <td> <?= $res['libelle'] ?> </td>
                    <td>
                        <a href="<?= LINK ?>niveau/classeroom/<?= $res['idGroupeNiveau'] ?>" class="fa-solid fa-circle-info" style="color: #1e3050;"></a>
                    </td>
                </tr>
